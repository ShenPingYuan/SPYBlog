//获取系统时间
var newDate = '';
var name = document.getElementById("nowTime").innerHTML;
getLangDate();
//值小于10时，在前面补0
...
function getLangDate() {
    ...
    document.getElementById("nowTime").innerHTML = "亲爱的管理员"+name+","+ timeValue + "好！ 欢迎使用SPY网站后台管理系统。当前时间为： " + newDate + "　" + week;
