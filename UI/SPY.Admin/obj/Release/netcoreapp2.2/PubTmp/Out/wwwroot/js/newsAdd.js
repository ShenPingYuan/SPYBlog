...
layui.use(['form', 'layer', 'layedit', 'laydate', 'upload'], function () {
    ...
    form.on("submit(addNews)", function (data) {
        ...
        //}, content:"application/json", function (res) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: JSON.stringify({
                newsName: data.field.articletitle,  //文章标题
                description: data.field.articledescription,  //文章摘要
                content: data.field.content,//ue.getContent(),  //文章内容
                newsImg: $(".thumbImg").attr("src"),  //缩略图
                classify: data.field.category,    //文章分类
                newsStatus: data.field.status,    //发布状态
                newsTime: submitTime,    //发布时间
                newsTop: data.field.newsTop == "on" ? "true" : "false",//是否置顶    
                author: data.field.author,//作者
            }),
