layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            { field: 'newsName', title: '消息名', width: 130, align: "center" },
            { field: 'newsUrl', title: '消息地址', width: 350 },
            {
            ...
            { title: '操作', width: 170, templet: '#latestNewsListBar', fixed: "right", align: "center" }
        ]]
    });
