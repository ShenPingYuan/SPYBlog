layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            { field: 'articleID', title: '文章ID', width:130, align:"center"},
            ...
            {field: 'newsLook', title: '浏览权限', align:'center'},
            {
                field: 'isTop', title: '是否置顶', align: 'center', templet: function (d) {
                    if (d.isTop == true) {
                        return '<input type="checkbox" name="isTop" lay-filter="isTop" lay-skin="switch" lay-text="是|否" checked>'
                    } else {
                        return '<input type="checkbox" name="isTop" lay-filter="isTop" lay-skin="switch" lay-text="是|否">'
                    }
                   
            }},
            { field: 'publishTime', title: '发布时间', align:'center', minWidth:110},
    ...
    function addNews(edit) {
        ...
        if (typeof (edit) != "undefined") {
            para = "?articleId=" + edit.articleID;
        }
        var index = layui.layer.open({
            title : "添加文章",
            type: 2,
            content: "/Content/AddArticle" + para,
